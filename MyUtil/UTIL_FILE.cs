...
namespace MyUtil
{
    public static class FILE
    {
        ...
        public static string AppFilePath(string file, bool autoCreate = true)
        {
            string filePath = System.IO.Path.Combine(AppFilePath(), file);
            if (autoCreate && !Directory.Exists(filePath))
            {
